...
export function MealCard({ meal }: MealCardProps) {
  ...
  if (!recipe) {
    return (
      <div className="flex min-h-[44px] items-center gap-4 rounded-2xl bg-white p-4 shadow-sm">
        <div
          className="h-14 w-14 shrink-0 rounded-xl bg-neutral-100"
          aria-hidden="true"
        />
        <div>
          <p className="font-serif text-base font-semibold text-neutral-400">
  ...
  return (
    <div className="rounded-2xl bg-white shadow-sm">
      ...
      >
        <div
          className="h-14 w-14 shrink-0 rounded-xl bg-brand-cream-dark"
          aria-hidden="true"
        />
        ...
        <div className="space-y-3 border-t border-neutral-100 px-4 pt-3 pb-4">
          ...
          <div>
            ...
            {ingredients.length > 0 ? (
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Ingredientes no disponibles todavía.
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {instructions.length > 0 ? (
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Instrucciones no disponibles todavía.
              </p>
            )}
          </div>
        </div>
